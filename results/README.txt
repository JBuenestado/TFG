...
BCE contains the results of the running of neural networks, with the NN being the same as in the previous folder. In its README file there is detailed information.
 ...
 ASR are some preliminary results and the numbers of each folder means the sets it was trained and testes with so T14 means trained with Set T1 and tested with Set T4
