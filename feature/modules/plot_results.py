...
def plot(filepaths, rows_to_skip, xycolumns=(0,1), stdColumn=None, plotStd=None, separator='\t', err_every=None, labels=None, showGrid=False, save_data=None, show_fig=True, xlim=None, ylim=None, xlabel=None, ylabel=None, labelsfontsize=12, ticksfontsize=16, legendncol=1, legendfontsize=16, title=None):
    '''This function takes:
    ...
    if title is not None:
        plt.title(title, fontsize=labelsfontsize)
